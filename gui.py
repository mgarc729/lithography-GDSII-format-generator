...
class AppGUI(tk.Tk):
    ...
    def generate_sections(self):
        ...
        margin = int(self.margin_ent.get())

        self.wafer.change_margin(margin)
    ...
    def initialize(self):
        ...
        self.margin_lbl = tk.Label(self.sectionsLayoutSection, text="Margin (mm):")
        ...
        self.distance_lbl = tk.Label(self.structureSection, text="Distance between structures(um):")
        self.radius_lbl = tk.Label(self.structureSection, text="Radius/length(um):")
        ...
        self.margin_ent = tk.Entry(self.sectionsLayoutSection, width=10)
        self.margin_ent.insert(0, '5')
        ...
        self.margin_ent.bind('<KeyPress>', self.check_only_int)
        ...
        self.margin_lbl.grid(row=1, column=2, padx=5, pady=5)
        self.margin_ent.grid(row=1, column=3, padx=5, pady=5)
...
window = AppGUI()
window.title("GDS Lithography mask generator")
